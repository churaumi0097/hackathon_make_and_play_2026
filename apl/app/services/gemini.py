...
def _fallback_result_message(analysis: er.EmotionAnalysis, extra_minutes: int) -> str:
    ...
    table = {
        "cooldown": f"＋{m}分、気持ちを整えながら最後まで歩けましたね。今日も本当におつかれさまでした。",
        "comfort": f"＋{m}分の遠回り、おつかれさまでした。近道では出会えない景色が、少しでも心を休ませてくれますように。",
        "afterglow": f"＋{m}分、今日の気持ちを大切に歩き切りましたね。その一歩一歩を、どうかゆっくり労ってあげてください。",
        "savor": f"＋{m}分、急がず丁寧に歩けましたね。今日の静かな時間も、がんばったあなたへの小さなご褒美です。",
        "neutral": f"＋{m}分、自分のために歩く時間を選べましたね。今日もここまで、本当におつかれさまでした。",
    }
...
歩き切ったことを最初にねぎらい、自分のために時間を使えたことをやさしく肯定するメッセージを、日本語で90文字以内・1〜2文で書いてください。皮肉はごく控えめにし、温かく安心できる言葉を優先してください。
トーン指針: {tone}
